...
struct Spi3VFirst: SpiPeripheral<Spi3VFirstPinPackage, PERIPHERAL_SPI1>,
	...
	Spi3VFirst(const Parameters& params) :
			SpiPeripheral<Spi3VFirstPinPackage, PERIPHERAL_SPI1>(params), Features(
					static_cast<Spi&>(*this))... {
	}
};
...
struct Spi3VSecond: SpiPeripheral<Spi3VSecondPinPackage, PERIPHERAL_SPI1>,
	...
	Spi3VSecond(const Parameters& params) :
			SpiPeripheral<Spi3VSecondPinPackage, PERIPHERAL_SPI1>(params), Features(
					static_cast<Spi&>(*this))... {
	}
};
...
struct Spi3VThird: SpiPeripheral<Spi3VThirdPinPackage, PERIPHERAL_SPI1>,
	...
	Spi3VThird(const Parameters& params) :
			SpiPeripheral<Spi3VThirdPinPackage, PERIPHERAL_SPI1>(params), Features(
					static_cast<Spi&>(*this))... {
	}
};
...
struct Spi5VFirst: SpiPeripheral<Spi5VFirstPinPackage, PERIPHERAL_SPI2>,
	...
	Spi5VFirst(const Parameters& params) :
			SpiPeripheral<Spi5VFirstPinPackage, PERIPHERAL_SPI2>(params), Features(
					static_cast<Spi&>(*this))... {
	}
};
...
struct Spi5VSecond: SpiPeripheral<Spi5VSecondPinPackage, PERIPHERAL_SPI2>,
	...
	Spi5VSecond(const Parameters& params) :
			SpiPeripheral<Spi5VSecondPinPackage, PERIPHERAL_SPI2>(params), Features(
					static_cast<Spi&>(*this))... {
	}
};
...
struct Spi5VThird: SpiPeripheral<Spi5VThirdPinPackage, PERIPHERAL_SPI2>,
	...
	Spi5VThird(const Parameters& params) :
			SpiPeripheral<Spi5VThirdPinPackage, PERIPHERAL_SPI2>(params), Features(
					static_cast<Spi&>(*this))... {
	}
};
...
class Encoders: public Encoder<TimerEnc1>,
		public Encoder<TimerEnc2>,
		public Encoder<TimerEnc3>,
		public Encoder<TimerEnc4> {
public:
	Encoders() :
			Encoder<TimerEnc1>(), Encoder<TimerEnc2>(), Encoder<TimerEnc3>(), Encoder<
					TimerEnc4>() {
...
public:
	MainV3() :
			led(pcled[13]), led1(pdleds[8]), led2(pdleds[9]), led3(pdleds[10]), led4(
					pdleds[11]), button1(pe[1], false), button2(pe[2], false), button3(
